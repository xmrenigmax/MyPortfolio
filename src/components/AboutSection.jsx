                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center w-full">
                    ...
                    <div className="space-y-6 text-glow">
                        ...
                        <div className='flex flex-col sm:flex-row gap-4 pt-4 justify-center'>
                            ...
                            <a href="/software.pdf" className="px-6 py-2 rounded-full border-2 border-primary text-primary hover:bg-primary/10 transition-colors duration-300" target="_blank" rel="noopener noreferrer">
                                Download CV
                            </a>
                        </div>
                    </div>
